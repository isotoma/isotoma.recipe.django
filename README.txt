...
originally created by Jeroen Vloothuis.
Forked to alter for our internal workflow and directory structure.
...
admin-script
  The name of the admin script created in the bin folder. This script is the
  equivalent of the `django-admin.py` Django normally creates. By default it
  uses the name of the section (the part between the `[ ]`) with '-admin' appended.
